...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* ══ WIDGET FLUTUANTE "FALE COM UM ESPECIALISTA" ══ */}
      <div style={{
        position: 'fixed', bottom: 24, right: 24, zIndex: 100,
        width: 220,
        background: '#04241D',
        border: '1px solid #19483D',
        borderRadius: 18,
        ...
        {/* Header */}
        <div style={{ padding: '14px 16px 10px', borderBottom: '1px solid #19483D' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: '#AAB5B2' }}>Central de Ajuda</span>
          </div>
        </div>
        ...
        <div style={{ padding: '14px 16px 16px', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: 14, fontWeight: 800, color: '#fff', marginBottom: 4, lineHeight: 1.3 }}>
              Fale com um especialista
            </p>
            <p style={{ fontSize: 10.5, color: '#AAB5B2', lineHeight: 1.6, marginBottom: 12 }}>
            ...
            <a
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#1EBC5B'; }}
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="white">
                ...
                <path d="M12 0C5.373 0 0 5.373 0 12c0 2.025.507 3.934 1.395 5.608L0 24l6.562-1.374A11.934 11.934 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.81 9.81 0 01-5.012-1.373l-.36-.214-3.724.78.793-3.633-.235-.373A9.818 9.818 0 012.182 12C2.182 6.575 6.575 2.182 12 2.182S21.818 6.575 21.818 12 17.425 21.818 12 21.818z"/>
              </svg>
              Enviar mensagem
            </a>
          </div>
          ...
          <div style={{
            ...
            background: 'linear-gradient(135deg, #0E8F6E, #0A6A52)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',

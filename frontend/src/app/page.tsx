...
import FiltrosBusca from '@/components/empreendimentos/FiltrosBusca';
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: '#faf9f6' }}>
      ...
      >
        {/* Logo */}
        <Link href="/" className="flex items-center shrink-0 mr-4" style={{ textDecoration: 'none' }}>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-[1fr_270px] gap-5 items-start" style={{ position: 'relative', zIndex: 5 }}>
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Filtros — bottom drawer */}
            <div className="flex justify-center">
              <FiltrosBusca onBuscar={buscar} loading={loading} />
            </div>
          </div>
      ...
      <footer style={{ background: '#0B1D2A', borderTop: '1px solid #1A3547', padding: '20px 32px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <LogoFaicoh height={30} textColor="white" />

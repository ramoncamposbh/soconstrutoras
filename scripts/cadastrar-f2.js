...
const EMPS = [
  ...
  { nome:'Walk Funcionários LUME',    dir:path.join(BASE_LUME,'2026-08-18-Walk Funcionários'),
    body:{ tipo:'apartamento', status:'lancamento',
    ...
    unidades:[] },
  { nome:'Walk Lourdes LUME',         dir:path.join(BASE_LUME,'2026-08-18-Walk Lourdes'),
    body:{ tipo:'apartamento', status:'lancamento',

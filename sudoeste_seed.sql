-- ============================================================
-- SEED: Construtora Sudoeste + 7 Empreendimentos
-- Executar no Neon SQL Editor (console.neon.tech)
-- ============================================================

BEGIN;

-- 1. Cria o usuário da Construtora Sudoeste
INSERT INTO users (email, password_hash, nome, role, ativo)
VALUES (
  'comercial@sudoeste.com.br',
  '$2b$12$B.j5/xhhQZ0OF1AzbbfrFegaHIVZQFTeaErTTZ/Gg4O5X6COpn/sK',
...
INSERT INTO construtoras (user_id, razao_social, nome_fantasia, cnpj)
SELECT u.id, 'Construtora Sudoeste Ltda.', 'Construtora Sudoeste', '08.819.541/0001-00'
FROM users u WHERE u.email = 'comercial@sudoeste.com.br'
...
-- Verificação
SELECT nome, cidade, preco_min, quartos_min, quartos_max, publicado
